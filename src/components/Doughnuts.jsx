...
import bannerImg from '../assets/doughnuts-images/CARAMEL-CLASSIC-DELIGHT-DOUGHNUT.png';
import choco from '../assets/doughnuts-images/doughnuts-1.jpg';
import chocochip from '../assets/doughnuts-images/doughnuts-2.jpg';
      ...
      <section id='menu-section' className="bg-gradient-to-b from-[#fff7f1] to-[#ffe4d2] py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#712d24] mb-4">Deliciously Soft</h2>
            <div className="w-24 h-1 bg-yellow-500 mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-xl mx-auto">
              Sink your teeth into our delightful doughnuts—each one crafted for a perfect bite.
            </p>
          </div>
          ...
          <div className="mt-16 bg-[#712d24] rounded-xl p-8 md:p-12 text-center text-white">
            <h3 className="text-3xl font-bold mb-4">Explore More Sweet Bites</h3>
            <p className="text-gray-200 max-w-2xl mx-auto mb-6">
              From fluffy pastries to creamy desserts, discover the best of our sweet collection.
            </p>
            <Link
              to="/cakes"
