...
import bannerImg from '../assets/fruitsmoothie-images/fruit-1.jpg';
import raspberry from '../assets/fruitsmoothie-images/fruit-1.jpg';
import strawberry from '../assets/fruitsmoothie-images/fruit-2.jpg';
import vanilla from '../assets/fruitsmoothie-images/fruit-4.jpg';
import blackCurrent from '../assets/fruitsmoothie-images/fruit-8.jpg';
import coldChocolate from '../assets/fruitsmoothie-images/fruit-11.jpg';
      ...
      <section className="relative min-h-screen bg-fixed bg-cover bg-center flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fadeIn">
            <span className="text-yellow-300">Fruit</span> Smoothies
          </h1>
          <div className="text-sm text-gray-300 flex justify-center items-center">
            <Link to="/" className="hover:text-yellow-300 transition-colors">HOME</Link>
            <span className="mx-2">&gt;</span>
            <span className="text-yellow-300">FRUIT SMOOTHIES</span>
          </div>
        </div>
      </section>
      ...
      <section id="menu-section" className="bg-gradient-to-b from-[#fff7f1] to-[#ffe4d2] py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#712d24] mb-4">Refreshing & Fruity</h2>
            <div className="w-24 h-1 bg-yellow-500 mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Enjoy vibrant and wholesome smoothies made with fresh fruits and rich blends.
            </p>
          </div>
          ...
          <div className="mt-16 bg-[#712d24] rounded-xl p-8 md:p-12 text-center text-white">
            <h3 className="text-3xl font-bold mb-4">Want More Chillers?</h3>
            <p className="text-gray-200 max-w-2xl mx-auto mb-6">
              Check out all our iced beverages, shakes, and special drinks from the menu.
            </p>
            <Link
              to="/drinks"
