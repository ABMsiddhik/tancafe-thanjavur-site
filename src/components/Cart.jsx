...
const Cart = () => {
  ...
  return (
    <>
      <Helmet>
        <title>TanCafe Cart in Thanjavur | Best Cafe in Thanjavur, Coffee Shop in Thanjavur, Premium Restaurant in Thanjavur, Vegetarian Restaurant in Thanjavur</title>
        <meta
          name="description"
          content="Review your order in TanCafe's cart in Thanjavur. Shop foods, drinks, and cakes from our best cafe in Thanjavur, coffee shop in Thanjavur, premium restaurant in Thanjavur, and vegetarian restaurant in Thanjavur. Order online at tancafe.co.in."
        />
        <meta
          name="keywords"
          content="TanCafe cart in Thanjavur, cafe in Thanjavur, coffee shop in Thanjavur, vegetarian hotel in Thanjavur, vegetarian restaurant in Thanjavur, premium restaurant in Thanjavur, restaurant and cafe in Thanjavur, famous cafe in Thanjavur, famous coffee shop in Thanjavur, famous vegetarian hotel in Thanjavur, famous premium restaurant in Thanjavur, best cafe in Thanjavur, best coffee shop in Thanjavur, best vegetarian restaurant in Thanjavur, best premium restaurant in Thanjavur, vegetarian coffee shop in Thanjavur, online food ordering in Thanjavur, food delivery in Thanjavur, cake orders in Thanjavur, online order delivery tancafe.co.in"
        />

        {/* Open Graph Tags */}
        <meta property="og:title" content="TanCafe Cart in Thanjavur | Best Cafe in Thanjavur, Coffee Shop in Thanjavur, Premium Restaurant in Thanjavur, Vegetarian Restaurant in Thanjavur" />
        <meta
          property="og:description"
          content="Manage your order in TanCafe's cart in Thanjavur, featuring foods, drinks, and cakes from our best cafe in Thanjavur, coffee shop in Thanjavur, premium restaurant in Thanjavur, and vegetarian restaurant in Thanjavur. Visit tancafe.co.in for online ordering."
        />
      ...
      <div className="p-4 sm:p-6 max-w-4xl mx-auto relative">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-2">
          ...
          {cartItems.length > 0 && (
            <button
              onClick={clearCart}
              className="flex justify-center items-center gap-1 bg-red-500 text-white px-3 sm:px-4 py-1 sm:py-2 rounded hover:bg-red-600 transition text-sm sm:text-base"
            >
              <FaTrash />
              Clear All
            </button>
