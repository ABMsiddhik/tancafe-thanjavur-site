...
import bannerImg from '../assets/burger-images/burger-3.jpg';
import paneer from '../assets/burger-images/burger-1.jpg';
import veg from '../assets/burger-images/burger-2.jpg';
import cheeseCorn from '../assets/burger-images/burger-3.jpg';
      ...
      <section className="relative min-h-screen bg-fixed bg-cover bg-center flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fadeIn">
            <span className="text-yellow-300">Burger</span> Specials
          </h1>
          <div className="text-sm text-gray-300 flex justify-center items-center">
            <Link to="/" className="hover:text-yellow-300 transition-colors">HOME</Link>
            <span className="mx-2"></span>
            <span className="text-yellow-300">BURGER</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-[#fff7f1] to-[#ffe4d2] py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#712d24] mb-4">Juicy & Satisfying</h2>
            <div className="w-24 h-1 bg-yellow-500 mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Taste the variety in our vegetarian burgers — crispy, cheesy, and full of flavor.
            </p>
          </div>
          ...
          <div className="mt-16 bg-[#712d24] rounded-xl p-8 md:p-12 text-center text-white">
            <h3 className="text-3xl font-bold mb-4">Still Hungry?</h3>
            <p className="text-gray-200 max-w-2xl mx-auto mb-6">
              Don’t stop with burgers — explore more from our delicious vegetarian lineup!
            </p>
            <Link
              to="/foods"
